...
**v3**: 2019年7月に公開されたV2バージョンおよび2025年8月に公開されたV3バージョンのみんなで翻刻上で翻刻されたテキストデータです。2025年11月時点で4,687万文字あります。プロジェクトID > 資料ID > ページ番号.txt という階層構造で保存されています。各プロジェクトおよび各資料についてのメタデータが info.tsv というファイルに保存されています。
